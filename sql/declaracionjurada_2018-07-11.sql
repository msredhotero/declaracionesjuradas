...
--
-- Servidor: localhost
-- Tiempo de generación: 11-07-2018 a las 06:55:14
...
CREATE TABLE IF NOT EXISTS `dbadeudos` (
  `idadeudo` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `fk_adeu_cab_idx` (`refdeclaracionjuradacabecera`),
  KEY `fk_adeu_to_idx` (`reftipooperacion`),
  KEY `fk_adeu_t_idx` (`reftitular`),
  KEY `fk_adeu_ta_idx` (`reftipoadeudo`)
...
CREATE TABLE IF NOT EXISTS `dbdecrementos` (
  `iddecremento` int(11) NOT NULL AUTO_INCREMENT,
  `refdeclaracionjuradacabecera` int(11) NOT NULL,
  ...
  PRIMARY KEY (`iddecremento`),
  KEY `fk_decrementos_cab_idx` (`refdeclaracionjuradacabecera`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `dbobservaciones` (
  ...
  KEY `fk_obs_cab_idx` (`refdeclaracionjuradacabecera`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `dbrecursos` (
  ...
  KEY `fk_recursos_cab_idx` (`refdeclaracionjuradacabecera`)
...
CREATE TABLE IF NOT EXISTS `tbtipoadeudo` (
  `idtipoadeudo` int(11) NOT NULL AUTO_INCREMENT,
  `tipoadeudo` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`idtipoadeudo`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=3 ;
