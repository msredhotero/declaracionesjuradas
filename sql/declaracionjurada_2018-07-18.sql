...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-07-2018 a las 01:09:23
...
`idconflictoeconomica` int(11) NOT NULL,
  `refdeclaracionjuradacabecera` int(11) NOT NULL,
  `reftipooperacion` int(11) NOT NULL,
  `refresponsable` int(11) NOT NULL,
  `descripcion` varchar(80) COLLATE utf8_spanish_ci NOT NULL,
  `fecha` date NOT NULL,
...
--
-- Estructura de tabla para la tabla `tbfrencuanciaanual`
--

CREATE TABLE IF NOT EXISTS `tbfrencuanciaanual` (
`idfrencuanciaanual` int(11) NOT NULL,
  `descripcion` varchar(80) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
ALTER TABLE `dbconflictoeconomica`
 ADD PRIMARY KEY (`idconflictoeconomica`), ADD KEY `fk_cie_cab_idx` (`refdeclaracionjuradacabecera`), ADD KEY `fk_cie_to_idx` (`reftipooperacion`), ADD KEY `fk_ci_res_idx` (`refresponsable`), ADD KEY `fk_ci_ts_idx` (`reftiposociedad`), ADD KEY `fk_ci_p_idx` (`refparticipacion`), ADD KEY `fk_ci_i_idx` (`refinicioparticipacion`);

--
-- Indices de la tabla `dbconflictopuestos`
--
ALTER TABLE `dbconflictopuestos`
 ADD PRIMARY KEY (`idconflictopuesto`), ADD KEY `fk_ci_cab_idx` (`refdeclaracionjuradacabecera`), ADD KEY `fk_ci_to_idx` (`reftipooperacion`), ADD KEY `fk_ci_r_idx` (`refresponsable`), ADD KEY `fk_ci_v_idx` (`refvinculo`), ADD KEY `fk_ci_fre_idx` (`reffrecuenciaanual`), ADD KEY `fk_ci_par_idx` (`refparticipacion`), ADD KEY `fk_ci_perso_idx` (`reftipopersonajuridica`), ADD KEY `fk_ci_col_idx` (`reftipocolaboracion`);
...
--
-- Indices de la tabla `tbfrencuanciaanual`
--
ALTER TABLE `tbfrencuanciaanual`
 ADD PRIMARY KEY (`idfrencuanciaanual`);
...
--
-- AUTO_INCREMENT de la tabla `tbfrencuanciaanual`
--
ALTER TABLE `tbfrencuanciaanual`
MODIFY `idfrencuanciaanual` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tbinicioparticipacion`
--
ALTER TABLE `tbinicioparticipacion`
MODIFY `idinicioparticipacion` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbtipocolaboracion`
MODIFY `idtipocolaboracion` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbtipopersonajuridica`
MODIFY `idtipopersonajuridica` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tbtiposociedad`
--
ALTER TABLE `tbtiposociedad`
MODIFY `idtiposociedad` int(11) NOT NULL AUTO_INCREMENT;
--
...
ADD CONSTRAINT `fk_ci_res` FOREIGN KEY (`refresponsable`) REFERENCES `tbresponsables` (`idresponsable`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ADD CONSTRAINT `fk_ci_fre` FOREIGN KEY (`reffrecuenciaanual`) REFERENCES `tbfrencuanciaanual` (`idfrencuanciaanual`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ADD CONSTRAINT `fk_ci_r` FOREIGN KEY (`refresponsable`) REFERENCES `tbresponsables` (`idresponsable`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ADD CONSTRAINT `fk_ci_v` FOREIGN KEY (`refvinculo`) REFERENCES `tbvinculos` (`idvinculo`) ON DELETE NO ACTION ON UPDATE NO ACTION;
