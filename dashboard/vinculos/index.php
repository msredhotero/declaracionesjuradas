...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Vinculos",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarVinculos";

$insertar = "insertarVinculos";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerVinculos(),1);
