    	...
    	<div class="cuerpoBox">
            ...
            <div class="row">
                ...
                <ul class="list-inline" style="margin-top:15px;">
                    ...
                    <li>
                        <button type="button" class="btn btn-danger varborrar" id="<?php echo mysql_result($resResultado, 0,'iddependienteeconomico'); ?>" style="margin-left:0px;">Eliminar</button>
                    </li>
                    <li>
