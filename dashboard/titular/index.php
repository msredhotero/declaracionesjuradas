...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Titular",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarTitular";

$insertar = "insertarTitular";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerTitular(),1);
