...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Frecuencia Anual",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Frecuencia Anual";

$plural = "Frecuencia Anual";

$eliminar = "eliminarFrecuenciaanual";

$insertar = "insertarFrecuenciaanual";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerFrecuenciaanual(),1);
