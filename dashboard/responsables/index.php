...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Responsables",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarResponsables";

$insertar = "insertarResponsables";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerResponsables(),1);
