...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Poder",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarPoder";

$insertar = "insertarPoder";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerPoder(),1);
