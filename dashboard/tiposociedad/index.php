...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Tipo Sociedad",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo Sociedad";

$plural = "Tipo Sociedades";

$eliminar = "eliminarTiposociedad";

$insertar = "insertarTiposociedad";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerTiposociedad(),1);
