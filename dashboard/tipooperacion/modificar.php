...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Tipo de Operacion",$_SESSION['refroll_predio'],'');
...
/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Tipo de Operacion";

$plural = "Tipos de Operaciones";

$eliminar = "eliminarTipooperacion";

$modificar = "modificarTipooperacion";

$idTabla = "idtipooperacion";
