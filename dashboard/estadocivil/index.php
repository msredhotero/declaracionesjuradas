...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Estado Civil",$_SESSION['refroll_predio'],'');
...
$lblCambio	 	= array('estadocivil');
$lblreemplazo	= array('Estado Civil');
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerEstadocivil(),1);
