...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Participacion",$_SESSION['refroll_predio'],'');


/////////////////////// Opciones pagina ///////////////////////////////////////////////
$singular = "Participacion";

$plural = "Participaciones";

$eliminar = "eliminarParticipacion";

$insertar = "insertarParticipacion";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerParticipacion(),1);
